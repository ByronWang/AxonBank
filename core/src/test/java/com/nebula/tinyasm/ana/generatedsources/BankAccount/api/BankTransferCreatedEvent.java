...
public class BankTransferCreatedEvent
{
  ...
  public BankTransferCreatedEvent(String bankTransferId, String sourceAxonBankAccountId, String destinationAxonBankAccountId, long amount)
  {
  ...
  {
    return "BankTransferCreatedEvent(" + "bankTransferId=" + this.bankTransferId + "," + "sourceAxonBankAccountId=" + this.sourceAxonBankAccountId + "," + "destinationAxonBankAccountId=" + this.destinationAxonBankAccountId + "," + "amount=" + this.amount + ")";
  }
}
