...
public class BankTransferDestinationCreditFailedEvent
{
  private String axonBankAccountId;
  private String bankTransferId;
  private long amount;
  
  public BankTransferDestinationCreditFailedEvent(String axonBankAccountId, String bankTransferId, long amount)
  {
  ...
  {
    return "BankTransferDestinationCreditFailedEvent(" + "axonBankAccountId=" + this.axonBankAccountId + "," + "bankTransferId=" + this.bankTransferId + "," + "amount=" + this.amount + ")";
  }
}
