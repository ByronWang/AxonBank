...
public class BankTransferSourceReturnMoneyCommand
{
  ...
  public BankTransferSourceReturnMoneyCommand(String axonBankAccountId, String bankTransferId, long amount)
  {
  ...
  {
    return "BankTransferSourceReturnMoneyCommand(" + "axonBankAccountId=" + this.axonBankAccountId + "," + "bankTransferId=" + this.bankTransferId + "," + "amount=" + this.amount + ")";
  }
}
