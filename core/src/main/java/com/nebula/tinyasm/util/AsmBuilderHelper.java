...
import com.nebula.tinyasm.SimpleMethodVisitor;
...
public class AsmBuilderHelper extends AsmBuilder implements Opcodes {
	...
	public static FieldVisitor visitDefineField(ClassVisitor cw, String fieldName, Class<?> fieldClass, Class<?> annotationClass) {
	...
	public static void visitDefineField(ClassVisitor cw, String fieldName, Class<?> fieldClass, Class<?> annotationClass, Object value) {
	...
	public static void visitInvokeInterface(MethodVisitor mv, Class<?> objectClass, Class<?> returnClass, String methodName, Class<?>... paramClasses) {
		visitInvokeInterface(mv, Type.getType(objectClass), Type.getType(returnClass), methodName, typesOf(paramClasses));
	}
	...
	public static void visitInvokeInterface(MethodVisitor mv, Class<?> objectClass, String methodName, Class<?>... paramClasses) {
		visitInvokeInterface(mv, Type.getType(objectClass), Type.VOID_TYPE, methodName, typesOf(paramClasses));
	}

	public static void visitInvokeInterface(MethodVisitor mv, Type objectType, Class<?> returnClass, String methodName, Class<?>... paramClasses) {
	...
	public static void visitInvokeInterface(MethodVisitor mv, Type objectType, Type returnType, String methodName, Class<?>... paramClasses) {
		visitInvokeInterface(mv, objectType, returnType, methodName, typesOf(paramClasses));
	}

	public static void visitInvokeSpecial(MethodVisitor mv, Class<?> objectClass, Class<?> returnClass, String methodName, Class<?>... paramClasses) {
	...
	public static void visitInvokeSpecial(MethodVisitor mv, Type objectType, Class<?> returnClass, String methodName, Class<?>... paramClasses) {
	...
	public static void visitInvokeSpecial(MethodVisitor mv, Type objectType, Type returnType, String methodName, Class<?>... paramClasses) {
		visitInvokeSpecial(mv, objectType, returnType, methodName, typesOf(paramClasses));
	}

	public static void visitInvokeStatic(MethodVisitor mv, Class<?> objectClass, Class<?> returnClass, String methodName, Class<?>... paramClasses) {
	...
	public static void visitInvokeStatic(MethodVisitor mv, Type objectType, Class<?> returnClass, String methodName, Class<?>... paramClasses) {
	...
	public static void visitInvokeStatic(MethodVisitor mv, Type objectType, Type returnType, String methodName, Class<?>... paramClasses) {
		visitInvokeStatic(mv, objectType, returnType, methodName, typesOf(paramClasses));
	}

	public static void visitInvokeVirtual(MethodVisitor mv, Class<?> objectClass, Class<?> returnClass, String methodName, Class<?>... paramClasses) {
		visitInvokeVirtual(mv, Type.getType(objectClass), Type.getType(returnClass), methodName, typesOf(paramClasses));
	}

	public static void visitInvokeVirtual(MethodVisitor mv, Class<?> objectClass, Type returnType, String methodName, Class<?>... paramClasses) {
	...
	public static void visitInvokeVirtual(MethodVisitor mv, Type objectType, Class<?> returnClass, String methodName, Class<?>... paramClasses) {
	...
	public static void visitInvokeVirtual(MethodVisitor mv, Type objectType, Type returnType, String methodName, Class<?>... paramClasses) {
