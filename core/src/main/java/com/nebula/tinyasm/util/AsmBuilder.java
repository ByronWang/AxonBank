...
public class AsmBuilder {
	...
	public static void visitInvokeInterface(MethodVisitor mv, int objectIndex, Type objectType, Type returnType, String methodName, Type... paramTypes) {
		mv.visitVarInsn(ALOAD, objectIndex);
		mv.visitMethodInsn(INVOKEINTERFACE, objectType.getInternalName(), methodName, Type.getMethodDescriptor(returnType, paramTypes), true);
	}

	public static void visitInvokeInterface(MethodVisitor mv, Type objectType, Type returnType, String methodName, Type... paramTypes) {
		mv.visitMethodInsn(INVOKEINTERFACE, objectType.getInternalName(), methodName, Type.getMethodDescriptor(returnType, paramTypes), true);
	}

	public static void visitInvokeSpecial(MethodVisitor mv, int objectIndex, Type objectType, Type returnType, String methodName, Type... paramTypes) {
		mv.visitVarInsn(ALOAD, objectIndex);
		mv.visitMethodInsn(INVOKESPECIAL, objectType.getInternalName(), methodName, Type.getMethodDescriptor(returnType, paramTypes), false);
	}

	public static void visitInvokeSpecial(MethodVisitor mv, Type objectType, Type returnType, String methodName, Type... paramTypes) {
		mv.visitMethodInsn(INVOKESPECIAL, objectType.getInternalName(), methodName, Type.getMethodDescriptor(returnType, paramTypes), false);
	}

	public static void visitInvokeStatic(MethodVisitor mv, int objectIndex, Type objectType, Type returnType, String methodName, Type... paramTypes) {
		mv.visitVarInsn(ALOAD, objectIndex);
		mv.visitMethodInsn(INVOKESTATIC, objectType.getInternalName(), methodName, Type.getMethodDescriptor(returnType, paramTypes), false);
	}

	public static void visitInvokeStatic(MethodVisitor mv, Type objectType, Type returnType, String methodName, Type... paramTypes) {
		mv.visitMethodInsn(INVOKESTATIC, objectType.getInternalName(), methodName, Type.getMethodDescriptor(returnType, paramTypes), false);
	}

	public static void visitInvokeVirtual(MethodVisitor mv, int objectIndex, Type objectType, Type returnType, String methodName, Type... paramTypes) {
		mv.visitVarInsn(ALOAD, objectIndex);
		mv.visitMethodInsn(INVOKEVIRTUAL, objectType.getInternalName(), methodName, Type.getMethodDescriptor(returnType, paramTypes), false);
	}

	public static void visitInvokeVirtual(MethodVisitor mv, Type objectType, Type returnType, String methodName, Type... paramTypes) {
		mv.visitMethodInsn(INVOKEVIRTUAL, objectType.getInternalName(), methodName, Type.getMethodDescriptor(returnType, paramTypes), false);
	}
