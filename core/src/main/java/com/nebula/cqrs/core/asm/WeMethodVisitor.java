...
public class WeMethodVisitor extends MethodVisitor implements MethodCode, MethodHeader, Opcodes {
    ...
    // {
    // visitGetField(mv, 0, typeController, "bankAccountRepository",
    // repoType);
    //
    // mv.visitVarInsn(ALOAD, 1);
    // visitInvokeInterface(mv, repoType, Object.class, "findOne",
    // Serializable.class);
    ...
    // Label l1 = new Label();
    // mv.visitLabel(l1);
    // mv.visitLocalVariable("this", typeController.getDescriptor(), null,
    // l0, l1, 0);
