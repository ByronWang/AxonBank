...
@Aggregate
public class BankAccountWithLog {
	private final Logger logger = LoggerFactory.getLogger(BankAccountWithLog.class);  
    ...
    private BankAccountWithLog() {
    }

    public BankAccountWithLog(String bankAccountId, long overdraftLimit) {
