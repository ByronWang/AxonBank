...
public class BankAccountControllerDump implements Opcodes {
	...
	public static byte[] dump() throws Exception {
		...
		cw.visit(52, ACC_PUBLIC + ACC_SUPER, "org/axonframework/samples/bank/web/MyBankAccountController", null, "java/lang/Object", null);

		cw.visitSource("MyBankAccountController.java", null);
		...
		}
		{
			...
			mv.visitFieldInsn(PUTFIELD, "org/axonframework/samples/bank/web/MyBankAccountController", "commandBus",
			...
			mv.visitFieldInsn(PUTFIELD, "org/axonframework/samples/bank/web/MyBankAccountController", "bankAccountRepository",
			...
			Label l4 = new Label();
			mv.visitLabel(l4);
			mv.visitLocalVariable("this", "Lorg/axonframework/samples/bank/web/MyBankAccountController;", null, l0, l4, 0);
		...
		}
		{
			...
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETFIELD, "org/axonframework/samples/bank/web/MyBankAccountController", "bankAccountRepository",
					"Lorg/axonframework/samples/bank/query/bankaccount/BankAccountRepository;");
			...
			Label l1 = new Label();
			mv.visitLabel(l1);
			mv.visitLocalVariable("this", "Lorg/axonframework/samples/bank/web/MyBankAccountController;", null, l0, l1, 0);
			mv.visitMaxs(1, 1);
			mv.visitEnd();
		}
		{
		...
		}
		{
			...
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETFIELD, "org/axonframework/samples/bank/web/MyBankAccountController", "commandBus",
					"Lorg/axonframework/commandhandling/CommandBus;");
		...
		}
		{
			...
			Label l3 = new Label();
			mv.visitLabel(l3);
			mv.visitLocalVariable("this", "Lorg/axonframework/samples/bank/web/MyBankAccountController;", null, l0, l3, 0);
